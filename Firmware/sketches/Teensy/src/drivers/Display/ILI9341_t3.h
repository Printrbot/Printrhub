...
#define ILI9341_ORIENTATION_LANDSCAPE_LEFT 3
#define ILI9341_ORIENTATION_LANDSCAPE_RIGHT 1
#define ILI9341_ORIENTATION_PORTRAIT_UP 0
#define ILI9341_ORIENTATION_PORTRAIT_DOWN 2
